"use strict";(self.webpackChunk_stylospectrum_ui=self.webpackChunk_stylospectrum_ui||[]).push([[801],{"./src/button/index.ts":(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__)=>{var lit=__webpack_require__("./node_modules/lit/index.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js"),class_map=__webpack_require__("./node_modules/lit/directives/class-map.js"),types=__webpack_require__("./src/types/index.ts");__webpack_require__("./src/icon/index.ts"),__webpack_require__("./src/tooltip/index.ts");var __decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let Button=class Button extends lit.WF{constructor(){super(...arguments),this.type=types.bW.Primary,this.htmlType=types.VQ.Button}static{this.styles=lit.AH`
  ...
  `}_handleChange(e){this.value=e.detail,this.validateRules()}_handleSlotChange(){const formControl=this.slotEls?.[0];formControl&&(formControl.id=this.name)}async _validateRule(rule){const validator=new dist_web.A({[this.name]:[rule]});let result=[];try{await Promise.resolve(validator.validate({[this.name]:this.value}))}catch(errObj){errObj.errors&&(result=errObj.errors.map((({message})=>message)))}return result}validateRules(){const promise=new Promise((async(resolve,reject)=>{for(let i=0;i<this.rules.length;i++){const errors=await this._validateRule(this.rules[i]);if(errors.length){reject(errors);break}}resolve([])}));return promise.catch((e=>e)).then((ruleErrors=>{if(!(this.slotEls[0]instanceof src_checkbox.A)){const input=this.slotEls[0];ruleErrors.length>0?(input.valueState=types.H6.Error,input.valueStateMessage=ruleErrors[0]):input.valueState=types.H6.None}})),promise}updated(changedProperties){changedProperties.has("value")&&(this.slotEls[0]instanceof src_checkbox.A?this.slotEls[0].checked=this.value:this.slotEls[0].value=this.value)}render(){const labelNode=this.label?lit.qy`<div class="stylospectrum-form-item-label-wrapper">
    ...
    `}};__decorate([(0,decorators.MZ)()],FormItem.prototype,"name",void 0),__decorate([(0,decorators.MZ)()],FormItem.prototype,"label",void 0),__decorate([(0,decorators.MZ)()],FormItem.prototype,"value",void 0),__decorate([(0,decorators.MZ)({type:Array,reflect:!1})],FormItem.prototype,"rules",void 0),__decorate([(0,decorators.KN)({flatten:!0})],FormItem.prototype,"slotEls",void 0),FormItem=__decorate([(0,decorators.EM)("stylospectrum-form-item")],FormItem);const form_form_item=FormItem;var form_decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let Form=class Form extends lit.WF{getFormItems(){return this.slotEls.filter((el=>el instanceof form_form_item))}getFieldsValue(){const values=this.getFormItems().map((el=>[el.name,el.value]));return Object.fromEntries(values)}setFieldsValue(values){const formItems=Object.fromEntries(this.getFormItems().map((el=>[el.name,el])));Object.keys(values).forEach((key=>{formItems[key].value=values[key]}))}resetFields(){const formItems=this.getFormItems(),values=Object.fromEntries(this.getFormItems().map((el=>[el.name,void 0])));this.setFieldsValue(values),formItems.forEach((item=>{const slot=item.shadowRoot?.querySelector("slot"),node=slot?.assignedElements({flatten:!0})?.[0];node instanceof input.A&&(node.valueState=types.H6.None,node.valueStateMessage="")}))}async validateFields(){let hasError=!1;try{await Promise.all(this.getFormItems().map((el=>el.validateRules())))}catch(e){hasError=!0}return hasError?null:this.getFieldsValue()}render(){return lit.qy`
      <form class="stylospectrum-form">
        <slot></slot>
      </form>
    `}};form_decorate([(0,decorators.KN)({flatten:!0})],Form.prototype,"slotEls",void 0),Form=form_decorate([(0,decorators.EM)("stylospectrum-form")],Form);__webpack_require__("./src/button/index.ts"),__webpack_require__("./src/link/index.ts");const stories={title:"Form",component:"stylospectrum-form",tags:["autodocs"]},Basic=(()=>{const formRef=(0,ref._)(),passwordRef=(0,ref._)(),forgotPassRef=(0,ref._)(),createAnAccRef=(0,ref._)();return lit.qy`
  ...
  `}constructor(){super(),this._dummyAnchor=document.createElement("a")}_isCrossOrigin(){const loc=window.location;return this._dummyAnchor.href=this.href,!(this._dummyAnchor.hostname===loc.hostname&&this._dummyAnchor.port===loc.port&&this._dummyAnchor.protocol===loc.protocol)}willUpdate(){const needsNoReferrer="_self"!==this.target&&this.href&&this._isCrossOrigin();this._rel=needsNoReferrer?"noreferrer noopener":void 0}_handleFocusIn(){this.focused=!0}_handleFocusOut(){this.focused=!1}_handleClick(e){this.href||e.preventDefault()}render(){return lit.qy`
    ...
    `}};__decorate([(0,decorators.MZ)({type:Boolean})],Link.prototype,"disabled",void 0),__decorate([(0,decorators.MZ)()],Link.prototype,"href",void 0),__decorate([(0,decorators.MZ)()],Link.prototype,"target",void 0),__decorate([(0,decorators.MZ)({type:Boolean,reflect:!0})],Link.prototype,"focused",void 0),__decorate([(0,decorators.wk)()],Link.prototype,"_rel",void 0),Link=__decorate([(0,decorators.EM)("stylospectrum-link")],Link)},"./src/tooltip/index.ts":(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__)=>{var lit=__webpack_require__("./node_modules/lit/index.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js");var types=__webpack_require__("./src/types/index.ts"),__decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let Tooltip=class Tooltip extends lit.WF{static{this.styles=lit.AH`
...
//# sourceMappingURL=form-stories.3d16a14a.iframe.bundle.js.map