  ...
  `},BotEntityForm=()=>{const formRef=(0,ref._)();return lit.qy`
    ...
    >
      ...
      <stylospectrum-form-list
        name="options"
        .renderChild=${(name,value)=>lit.qy`<div style="display:flex;gap:.5rem">
            ...
            <stylospectrum-button
              icon="less"
              @click=${()=>{formRef.value?.list.options.delete(name),console.log(value)}}
            ></stylospectrum-button>
          </div> `}
      >
      </stylospectrum-form-list>
...
//# sourceMappingURL=form-stories.6b1d252e.iframe.bundle.js.map