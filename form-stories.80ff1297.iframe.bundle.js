"use strict";(self.webpackChunk_stylospectrum_ui=self.webpackChunk_stylospectrum_ui||[]).push([[801],{"./src/button/index.ts":(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__)=>{var lit=__webpack_require__("./node_modules/lit/index.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js"),class_map=__webpack_require__("./node_modules/lit/directives/class-map.js"),types=__webpack_require__("./src/types/index.ts");__webpack_require__("./src/icon/index.ts"),__webpack_require__("./src/tooltip/index.ts");var __decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let Button=class Button extends lit.WF{constructor(){super(...arguments),this.type=types.bW.Primary,this.htmlType=types.VQ.Button}static{this.styles=lit.AH`
  ...
  `}get effectiveTabIndex(){const tabindex=this.getAttribute("tabindex");return this.disabled?void 0:tabindex||"0"}_handleKeyDown(e){(0,Keys.xC)(e)&&e.preventDefault(),(0,Keys.RI)(e)&&this.toggle(!0)}_handleKeyUp(e){(0,Keys.xC)(e)&&this.toggle(!0)}toggle(_key=!1){_key&&(this.inputEle.checked=!this.inputEle.checked);const checked=this.inputEle.checked;this.disabled||this.indeterminate||(this._controlled||(this._innerChecked=checked),this.changeEvent.emit(checked))}willUpdate(_changedProperties){super.willUpdate(_changedProperties),_changedProperties.has("checked")&&!this.indeterminate&&(this._controlled=!0,this._innerChecked=this.checked)}render(){const checkNode=this._innerChecked&&!this.indeterminate?lit.qy`<stylospectrum-icon
  ...
  `}connectedCallback(){super.connectedCallback(),this.value=getValue(this.getNamePath(),this._formConsumer.getStore()),requestAnimationFrame((()=>{this.slotEls[0]instanceof src_checkbox.A||!this.value||(this.slotEls[0].value=this.value)})),this._formConsumer&&(this.cancelRegisterFunc=this._formConsumer.registerField(this)),this.listName=(this._formListConsumer?.listNamePath||[]).join("_")}disconnectedCallback(){super.disconnectedCallback(),this.cancelRegisterFunc?.()}getNamePath(){const namePath=Array.isArray(this.name)?this.name:[this.name];return this._formListConsumer?[...this._formListConsumer.listNamePath,...namePath]:namePath}getFieldId(){return this.getNamePath().join("_")}_handleChange(e){e.target instanceof multi_input.A||(this.value=e.detail,this._formConsumer.setStore(this.getNamePath(),this.value),this.validateRules())}_handleEnter(e){e.target instanceof multi_input.A&&(this.value=[...this.value||[],e.detail],this._formConsumer.setStore(this.getNamePath(),this.value),this.validateRules())}_handleTokenDelete(e){this.value=this.value.filter((item=>item.id!==e.detail)),this._formConsumer.setStore(this.getNamePath(),this.value)}_handleSlotChange(){const formControl=this.slotEls?.[0];formControl&&(formControl.id=this.getFieldId())}async _validateRule(rule){const validator=new dist_web.A({[this.getFieldId()]:[rule]});let result=[];try{await Promise.resolve(validator.validate({[this.getFieldId()]:this.value}))}catch(errObj){errObj.errors&&(result=errObj.errors.map((({message})=>message)))}return result}validateRules(){const promise=new Promise((async(resolve,reject)=>{for(let i=0;i<this.rules.length;i++){const errors=await this._validateRule(this.rules[i]);if(errors.length){reject(errors);break}}resolve([])}));return promise.catch((e=>e)).then((ruleErrors=>{if(!(this.slotEls[0]instanceof src_checkbox.A)){const input=this.slotEls[0];ruleErrors.length>0?(input.valueState=types.H6.Error,input.valueStateMessage=ruleErrors[0]):input.valueState=types.H6.None}})),promise}updated(changedProperties){changedProperties.has("value")&&(this.slotEls[0]instanceof src_checkbox.A?this.slotEls[0].checked=this.value:this.slotEls[0].value=this.value)}render(){const labelNode=this.label?lit.qy`<div class="stylospectrum-form-item-label-wrapper">
    ...
    `}};form_item_decorate([(0,decorators.MZ)()],FormItem.prototype,"name",void 0),form_item_decorate([(0,decorators.MZ)()],FormItem.prototype,"label",void 0),form_item_decorate([(0,decorators.MZ)()],FormItem.prototype,"value",void 0),form_item_decorate([(0,decorators.MZ)({type:Array,reflect:!1})],FormItem.prototype,"rules",void 0),form_item_decorate([(0,decorators.KN)({flatten:!0})],FormItem.prototype,"slotEls",void 0),form_item_decorate([(0,context.Fg)({context:formContext,subscribe:!0})],FormItem.prototype,"_formConsumer",void 0),form_item_decorate([(0,context.Fg)({context:formListContext,subscribe:!0})],FormItem.prototype,"_formListConsumer",void 0),form_item_decorate([(0,decorators.wk)()],FormItem.prototype,"listName",void 0),FormItem=form_item_decorate([(0,decorators.EM)("stylospectrum-form-item")],FormItem);var repeat=__webpack_require__("./node_modules/lit/directives/repeat.js"),form_list_decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let FormList=class FormList extends lit.WF{constructor(){super(...arguments),this.defaultValues=[],this.values=[],this.keyManager={keys:[],id:0},this.cancelRegisterFunc=null,this._provider=new context.DT(this,{context:formListContext})}willUpdate(_changedProperties){_changedProperties.has("name")&&(this.cancelRegisterFunc?.(),this.cancelRegisterFunc=this._formConsumer.registerList(this.getFieldId(),this),this._provider.setValue({listNamePath:this.getNamePath()})),_changedProperties.has("values")&&requestAnimationFrame((()=>{const formItemArr=[];if(this._formConsumer.getFormItems().forEach((el=>{el.listName===this.getFieldId()&&formItemArr.push(el)})),formItemArr.length>0){const formItems=Object.fromEntries(formItemArr.map((el=>[el.getFieldId(),el])));this.values.forEach(((value,index)=>{value&&"object"==typeof value&&Object.keys(value).map((key=>{formItems[`${this.getFieldId()}_${index}_${key}`]&&(formItems[`${this.getFieldId()}_${index}_${key}`].value=value[key])}))}))}}))}getNamePath(){const namePath=Array.isArray(this.name)?this.name:[this.name];return this._formListConsumer?[...this._formListConsumer.listNamePath,...namePath]:namePath}getFieldId(){return this.getNamePath().join("_")}getValues(){return getValue(this.getNamePath(),this._formConsumer.getStore())||this.defaultValues}add(value=null){this.values=[...this.getValues(),value],this._formConsumer.setStore(this.getNamePath(),this.values),this.keyManager={keys:[...this.keyManager.keys,this.keyManager.id],id:this.keyManager.id+1}}delete(index){this.values=this.getValues().filter(((_,i)=>i!==index)),this._formConsumer.setStore(this.getNamePath(),this.values),this.keyManager={keys:this.keyManager.keys.filter(((_,i)=>i!==index)),id:this.keyManager.id}}connectedCallback(){super.connectedCallback(),this._provider.setValue({listNamePath:this.getNamePath()}),this.cancelRegisterFunc=this._formConsumer.registerList(this.getFieldId(),this),this.values=this.getValues(),this.values.forEach((()=>{this.keyManager={keys:[...this.keyManager.keys,this.keyManager.id],id:this.keyManager.id+1}}))}disconnectedCallback(){super.disconnectedCallback(),this.cancelRegisterFunc?.()}render(){return(0,repeat.u)(this.values,((_,index)=>{let key=this.keyManager.keys[index];return void 0===key&&(this.keyManager.keys[index]=this.keyManager.id,key=this.keyManager.keys[index],this.keyManager.id+=1),key}),((value,index)=>this.renderChild(index,value)))}};form_list_decorate([(0,decorators.MZ)()],FormList.prototype,"name",void 0),form_list_decorate([(0,decorators.MZ)({type:Function})],FormList.prototype,"renderChild",void 0),form_list_decorate([(0,decorators.MZ)({type:Array})],FormList.prototype,"defaultValues",void 0),form_list_decorate([(0,decorators.wk)()],FormList.prototype,"values",void 0),form_list_decorate([(0,decorators.wk)()],FormList.prototype,"keyManager",void 0),form_list_decorate([(0,context.Fg)({context:formListContext,subscribe:!0})],FormList.prototype,"_formListConsumer",void 0),form_list_decorate([(0,context.Fg)({context:formContext,subscribe:!0})],FormList.prototype,"_formConsumer",void 0),FormList=form_list_decorate([(0,decorators.EM)("stylospectrum-form-list")],FormList);__webpack_require__("./src/button/index.ts"),__webpack_require__("./src/link/index.ts"),__webpack_require__("./src/textarea/index.ts"),__webpack_require__("./src/icon/data/less.ts");var style_map=__webpack_require__("./node_modules/lit/directives/style-map.js"),rule_builder_form_decorate=(__webpack_require__("./src/select/index.ts"),__webpack_require__("./src/icon/data/add.ts"),__webpack_require__("./src/icon/data/navigation-down-arrow.ts"),__webpack_require__("./src/icon/data/navigation-right-arrow.ts"),function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r});const ruleBuilderFormContext=(0,context.q6)("rule-builder-form");let RuleBuilderFormRow=class RuleBuilderFormRow extends lit.WF{constructor(){super(...arguments),this._popoverRef=(0,ref._)()}static{this.styles=lit.AH`
    :host {
      display: flex;
      align-items: center;
  ...
  `}render(){return this.isGroup?lit.qy`<rule-builder-form-group
        .name=${[this.name,"subExpr"]}
        .nameGroup=${this.nameGroup}
      >
      </rule-builder-form-group>`:lit.qy`
      <div style="display:flex;gap:.5rem;">
        ...
        >
          <stylospectrum-select
            .options=${[{id:"color",name:"color"},{id:"size",name:"size"},{id:"type",name:"type"}]}
          >
          </stylospectrum-select>
        </stylospectrum-form-item>
      ...
      <div
        style=${(0,style_map.W)({display:"flex",gap:"0.5rem",marginRight:.5625*this.offset+"rem"})}
      >
        <stylospectrum-button
          type="Tertiary"
          icon="add"
          @click=${e=>{this._popoverRef.value?.showAt(e.target)}}
        >
        </stylospectrum-button>
        ...
        <stylospectrum-button
          type="Tertiary"
          icon="less"
          @click=${()=>{this._consumer.getForm().list[this.nameGroup.join("_")].delete(parseInt(this.name)),this._consumer.forceRender()}}
        >
        </stylospectrum-button>

        <stylospectrum-popover
          ${(0,ref.K)(this._popoverRef)}
          placement="Bottom"
          hide-footer
        >
          <stylospectrum-list-item
            @click=${()=>{this._consumer.getForm().list[this.nameGroup.join("_")].add(),this._popoverRef.value?.hide()}}
          >
            Create new row
          </stylospectrum-list-item>

          <stylospectrum-list-item
            @click=${()=>{this._consumer.getForm().list[this.nameGroup.join("_")].add({isGroup:!0}),this._popoverRef.value?.hide(),this._consumer.forceRender()}}
          >
            Create new group
          </stylospectrum-list-item>
        </stylospectrum-popover>
      </div>
    `}};rule_builder_form_decorate([(0,context.Fg)({context:ruleBuilderFormContext,subscribe:!0})],RuleBuilderFormRow.prototype,"_consumer",void 0),rule_builder_form_decorate([(0,decorators.MZ)({type:String})],RuleBuilderFormRow.prototype,"name",void 0),rule_builder_form_decorate([(0,decorators.MZ)({type:Array})],RuleBuilderFormRow.prototype,"nameGroup",void 0),rule_builder_form_decorate([(0,decorators.MZ)({type:Boolean})],RuleBuilderFormRow.prototype,"isGroup",void 0),rule_builder_form_decorate([(0,decorators.MZ)({type:Number})],RuleBuilderFormRow.prototype,"offset",void 0),RuleBuilderFormRow=rule_builder_form_decorate([(0,decorators.EM)("rule-builder-form-row")],RuleBuilderFormRow);let RuleBuilderFormGroup=class RuleBuilderFormGroup extends lit.WF{constructor(){super(...arguments),this.nameGroup=[],this._collapsed=!1,this._deleted=!1,this._offset=0}static{this.styles=lit.AH`
    :host {
      display: flex;
      gap: 1rem;
  ...
  `}willUpdate(){requestAnimationFrame((()=>{const numberOfGroup=Math.max(...Object.keys(this._consumer.getForm().list).map((key=>key.split("_").filter((k=>"subExpr"===k)).length))),level=[...this.nameGroup,...this.name].filter((k=>"subExpr"===k)).length;this._offset=numberOfGroup-level}))}render(){return this._deleted?lit.s6:lit.qy`<stylospectrum-button
        type="Tertiary"
        icon=${this._collapsed?"navigation-right-arrow":"navigation-down-arrow"}
      ...
      <div style="display:flex;gap:.5rem;flex-direction:column;width:100%">
        <div style="display:flex;gap:.5rem;justify-content:space-between;">
          ...
          >
            <stylospectrum-select
              .options=${[{id:"and",name:"and"},{id:"or",name:"or"}]}
            >
            </stylospectrum-select>
          </stylospectrum-form-item>

          <stylospectrum-button
            style=${(0,style_map.W)({marginRight:.5625*this._offset+"rem"})}
            type="Tertiary"
            icon="less"
            @click=${()=>{this._consumer.getForm().list[this.nameGroup.join("_")].delete(parseInt(this.name[0])),this._deleted=!0,this._consumer.forceRender()}}
          >
          </stylospectrum-button>
        </div>

        <stylospectrum-form-list
          style=${(0,style_map.W)({flexDirection:"column",gap:".5rem",display:this._collapsed?"none":"flex"})}
          .defaultValues=${[""]}
          .name=${this.name}
          .renderChild=${(name,value)=>lit.qy`<rule-builder-form-row
              .name=${name}
      ...
      </div>`}};rule_builder_form_decorate([(0,context.Fg)({context:ruleBuilderFormContext,subscribe:!0})],RuleBuilderFormGroup.prototype,"_consumer",void 0),rule_builder_form_decorate([(0,decorators.MZ)({type:Array})],RuleBuilderFormGroup.prototype,"name",void 0),rule_builder_form_decorate([(0,decorators.MZ)({type:Array})],RuleBuilderFormGroup.prototype,"nameGroup",void 0),rule_builder_form_decorate([(0,decorators.wk)()],RuleBuilderFormGroup.prototype,"_collapsed",void 0),rule_builder_form_decorate([(0,decorators.wk)()],RuleBuilderFormGroup.prototype,"_deleted",void 0),rule_builder_form_decorate([(0,decorators.wk)()],RuleBuilderFormGroup.prototype,"_offset",void 0),RuleBuilderFormGroup=rule_builder_form_decorate([(0,decorators.EM)("rule-builder-form-group")],RuleBuilderFormGroup);let RuleBuilderForm=class RuleBuilderForm extends lit.WF{constructor(){super(...arguments),this._provider=new context.DT(this,{context:ruleBuilderFormContext}),this._form=(0,ref._)()}connectedCallback(){super.connectedCallback(),this._provider.setValue({getForm:()=>this._form.value,forceRender:()=>{this._forceRender={}}})}render(){return lit.qy`<stylospectrum-form ${(0,ref.K)(this._form)}>
      ...
      <stylospectrum-button
        style="margin-top:1rem"
        @click=${async()=>{this._form.value?.setFieldsValue({type:"and",subExpr:[{field:"color",operator:"==",value:"blue"},{type:"or",subExpr:[{field:"type",operator:"==",value:"jean"},{field:"size",operator:"==",value:"s"}]}]}),this._forceRender={}}}
      >
        set fields
      </stylospectrum-button>`}};rule_builder_form_decorate([(0,decorators.wk)()],RuleBuilderForm.prototype,"_forceRender",void 0),RuleBuilderForm=rule_builder_form_decorate([(0,decorators.EM)("rule-builder-form")],RuleBuilderForm);const stories={title:"Form",component:"stylospectrum-form",tags:["autodocs"]},LoginForm=()=>{const formRef=(0,ref._)(),passwordRef=(0,ref._)(),forgotPassRef=(0,ref._)(),createAnAccRef=(0,ref._)();return lit.qy`
  ...
  `},stories_RuleBuilderForm=()=>lit.qy`<rule-builder-form></rule-builder-form>`},"./src/icon/data/accept.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>__WEBPACK_DEFAULT_EXPORT__}),(0,__webpack_require__("./src/icon/util.ts").p)("accept",{pathData:"M187 416q-12 0-20-9L71 299q-7-7-7-17 0-11 7.5-18.5T90 256q12 0 19 9l77 87 217-247q8-9 19-9t18.5 7.5T448 122q0 10-6 16L206 407q-7 9-19 9z"});const __WEBPACK_DEFAULT_EXPORT__="accept"},"./src/icon/data/add.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>__WEBPACK_DEFAULT_EXPORT__}),(0,__webpack_require__("./src/icon/util.ts").p)("add",{pathData:"M454 230q11 0 18.5 7.5T480 256t-7.5 18.5T454 282H282v172q0 11-7.5 18.5T256 480t-18.5-7.5T230 454V282H58q-11 0-18.5-7.5T32 256t7.5-18.5T58 230h172V58q0-11 7.5-18.5T256 32t18.5 7.5T282 58v172h172z"});const __WEBPACK_DEFAULT_EXPORT__="add"},"./src/icon/data/less.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>__WEBPACK_DEFAULT_EXPORT__}),(0,__webpack_require__("./src/icon/util.ts").p)("less",{pathData:"M454 275H58q-11 0-18.5-7T32 250t7.5-18.5T58 224h396q11 0 18.5 7.5T480 250t-7.5 18-18.5 7z"});const __WEBPACK_DEFAULT_EXPORT__="less"},"./src/icon/data/navigation-down-arrow.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>__WEBPACK_DEFAULT_EXPORT__}),(0,__webpack_require__("./src/icon/util.ts").p)("navigation-down-arrow",{pathData:"M96 186q0-11 7.5-18.5T122 160q10 0 18 8l116 121 116-121q8-8 18-8 11 0 18.5 7.5T416 186q0 10-7 17L275 344q-8 8-19 8-12 0-18-8L103 203q-7-7-7-17z"});const __WEBPACK_DEFAULT_EXPORT__="navigation-down-arrow"},"./src/icon/data/navigation-right-arrow.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>__WEBPACK_DEFAULT_EXPORT__}),(0,__webpack_require__("./src/icon/util.ts").p)("navigation-right-arrow",{pathData:"M186 416q-11 0-18.5-7.5T160 390q0-10 8-18l121-116-121-116q-8-8-8-18 0-11 7.5-18.5T186 96q10 0 17 7l141 134q8 8 8 19 0 12-8 18L203 409q-7 7-17 7z"});const __WEBPACK_DEFAULT_EXPORT__="navigation-right-arrow"},"./src/icon/data/slim-arrow-down.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>__WEBPACK_DEFAULT_EXPORT__}),(0,__webpack_require__("./src/icon/util.ts").p)("slim-arrow-down",{pathData:"M96 186q0-11 7.5-18.5T122 160q10 0 18 8l116 121 116-121q8-8 18-8 11 0 18.5 7.5T416 186q0 10-7 17L275 344q-8 8-19 8-12 0-18-8L103 203q-7-7-7-17z"});const __WEBPACK_DEFAULT_EXPORT__="slim-arrow-down"},"./src/label/index.ts":(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__)=>{var lit=__webpack_require__("./node_modules/lit/index.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js");var __decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let Label=class Label extends lit.WF{constructor(){super(...arguments),this._colonSymbol=":"}static{this.styles=lit.AH`
...
//# sourceMappingURL=form-stories.80ff1297.iframe.bundle.js.map